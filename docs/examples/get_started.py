...
# Example conversion to a `oleo` format

gdsfactory_netlist = mzi.get_netlist()
# oleo.convert_gdsfactory_netlist(gdsfactory_netlist)

# ## Create Interactive Widget

oleo.interactive_netlist_graph(gdsfactory_netlist)
...
oleo.interactive_netlist_graph(gcl_netlist)
